...
<body>
        ...
        <div class="support-widget">
            ...
            <div class="support-menu" id="supportMenu">
                ...
                <div class="support-options">
                    ...
                    <a href="https://wa.me/+212613374422?text=Bonjour%20!%20J%27aimerais%20avoir%20des%20informations%20sur%20vos%20produits%20de%20mobilier.%20Pouvez-vous%20m%27aider%20?"
    ...
    <script>
        ...
        function showFeedbackForm() {
            alert('Redirection vers le formulaire d\'avis...');
        }

        // Animation d'attention périodique
        setInterval(() => {
            if (!isMenuOpen && !chatModal.classList.contains('active')) {
